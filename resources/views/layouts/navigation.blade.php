            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <img src="{{ asset('images/icon.png') }}" alt="Image Description" width="50">
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('gang')" :active="request()->routeIs('gang')">
                        {{ __('Gangs') }}
                    </x-nav-link>
                </div>  
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">            
            ...
            <div class="mt-3 space-y-1">
                ...
                <x-responsive-nav-link :href="route('combatlog')" :active="request()->routeIs('combatlog')">
                        {{ __('Combat Log') }}
                </x-responsive-nav-link>
                <x-responsive-nav-link :href="route('travel')" :active="request()->routeIs('travel')">
                        {{ __('Travel') }}
                </x-responsive-nav-link>
